                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('video.update', ['id' => $video->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="title" value="{{ old('title', $video->title) }}" placeholder="例）Line Dance in OKAYAMA（40文字まで)" maxlength="40">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="description" class="form-control" name="description" placeholder="動画の説明（必須 1,000文字まで）(MusicName, DancerName, Place etc.)" rows="7" maxlength="1000">{{ old('description', $video->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="sell-price">
                          ...
                          <div>
                            <div class="price-content">
                              ...
                              <div class="col-md-6">
                                  <input id="video-price" type="text" class="form-control" name="price" value="{{ old('price', $video->price) }}" placeholder="例）300">
